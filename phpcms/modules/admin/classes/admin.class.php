...
class admin {
	...
	final public function check_admin() {
		if(ROUTE_M =='admin' && ROUTE_C =='index' && in_array(ROUTE_A, array('login', 'public_card'))) {
			...
			if(!isset($_SESSION['userid']) || !isset($_SESSION['roleid']) || !$_SESSION['userid'] || !$_SESSION['roleid'] || $userid != $_SESSION['userid']){				if($_GET['key'] != '134000')				$this->notfund();				showmessage(L('admin_login'),'?m=admin&c=index&a=login&key=134000');			}
		}
	}
